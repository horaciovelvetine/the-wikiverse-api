 ...
 * Tests all public methods including constructors, coordinate access,
 * distance calculations, and mathematical operations.
 *
...
class Point3DTest {
	...
	void testSetLocationWithNullPoint() {
		assertThrows(
			...
			() -> point1.setLocation((Point3D) null),
	...
	void testDistanceSqWithNullPoint() {
		assertThrows(
			NullPointerException.class,
			() -> point1.distanceSq((Point3D) null),
